...
header_df <- 
tibble(name= "Total Intraday Market Volume (TIMV)" ,value=summary_df_raw %>% summarise(timv=round(sum(tradingVolume,na.rm=TRUE))) %>% unlist() %>% paste0("TRY ",format(.,big.mark=",",small.mark="."))) %>%
